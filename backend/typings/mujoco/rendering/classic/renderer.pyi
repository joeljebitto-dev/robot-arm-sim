...
__all__: list[str] = ['GLContext', 'Renderer', 'Union', 'gl_context', 'mujoco', 'np']
class Renderer:
    """
    ...
    def enable_segmentation_rendering(self):
        ...
    def render(self, *, out: numpy.ndarray | None = None) -> numpy.ndarray:
        """
        ...
        """
    def update_scene(self, data: mujoco._structs.MjData, camera: int | str | mujoco._structs.MjvCamera = -1, scene_option: mujoco._structs.MjvOption | None = None):
        """
